...
### OCI Cross-Tenancy Transit Networking Using LPG, DRG, and FastConnect
...
**Specialization:** Computer Network and Architecture
...
* **[Engineering a Resilient Tier III to Tier IV DC-DC Backbone Using Dark Fiber and DWDM Transport](https://medium.com/@heerok)**, Medium, May 2026.
* **[Designing OCI Cross-Tenancy Transit Networking Using LPG, DRG, and FastConnect](https://medium.com/the-resilience-blueprint/designing-oci-cross-tenancy-transit-networking-using-lpg-drg-and-fastconnect-d9175b1b5609)**, Medium, May 2026.
* **[Oracle Cloud Infrastructure Network Firewall Routing Design for Secure Egress Inspection](https://medium.com/the-resilience-blueprint/oci-network-firewall-routing-design-for-secure-egress-inspection-in-oci-6a393b739710)**, Medium, May 2026.
* **[When TCP Works but HTTPS Fails: A Real MTU/TLS Troubleshooting Case](https://medium.com/@heerok)**, Medium, May 2026.
* **[Building Redundant IPSec VPN with IP SLA and Static Route Failover in Cisco Routers](https://medium.com/the-resilience-blueprint/building-redundant-ipsec-vpn-with-ip-sla-and-static-route-failover-in-cisco-routers-fd3ddefd82a0)**, Medium, November 2025.

Certifications And Training
======

* Cloud Architecture with Google Cloud Specialization, Google, October 2020
* Cloud Engineering with Google Cloud Specialization, Google, October 2020
* Google Cloud Networking Specialization, Google, October 2020
* Intel Network Academy - Network Transformation 102, Intel Corporation, October 2020
* Hands on DNS and DNSSEC Deployment, BGD e-GOV CIRT, September 2020
* OptiX OSN 1800V Operation and Maintenance, Huawei, September 2020
* Accredited Operations Specialist (AOS), Uptime Institute, May 2019
* MDC Operation and Maintenance, ZTE Corporation, March 2017
* Aviatrix Certified Engineer - Multi-Cloud Network Associate, Aviatrix, August 2020 - August 2024
* Cisco Certified Network Associate Routing and Switching (CCNA), Cisco, January 2019 - January 2022
...
**American International University-Bangladesh (AIUB), March 2023**

Awarded for academic excellence with CGPA 3.95 and above, no grade lower than B+, and no retake, withdrawn, or incomplete courses.

Volunteer Experience
======

### Moderator, IEEE AIUB Student Branch

**January 2011 - December 2011**

* Organized project fairs, workshops, and seminars.

Professional Memberships
======

* AIUB Alumni Society, Member, April 2023 - Present
* APNIC, Member, March 2021 - Present
* IEEE
...
* Email: [heerok.mutsuddy@bdccl.gov.bd](mailto:heerok.mutsuddy@bdccl.gov.bd)
* LinkedIn: [linkedin.com/in/heerok](https://www.linkedin.com/in/heerok/)
* Medium: [medium.com/@heerok](https://medium.com/@heerok)
* GitHub: [github.com/heerok-ict](https://github.com/heerok-ict)
